...
**How it works:** Prepare multiple pairs of opposing adjectives (adjective pairs) such as "bright - dark" and "artificial - natural," and have respondents rate each on a 5- or 7-point scale indicating which adjective they lean toward ([reference](https://www.jstage.jst.go.jp/article/jje/45/5/45_5_263/_pdf/-char/ja)).
...
References: [Impression evaluation of AR installations](https://www.jstage.jst.go.jp/article/jjske/24/2/24_TJSKE-D-24-00046/_pdf/-char/ja), [Impression evaluation of virtual forest bathing content](https://www.mdpi.com/1660-4601/19/3/1202), [Graphing SD method survey results](https://note.com/shinoan_01/n/nd38277730941)

### 2. Semi-Structured Interview

A research method where questions are prepared in advance, but additional questions are flexibly added or modified based on the respondent's answers to dig deeper ([reference](https://www.asmarq.co.jp/column/column-cat/glossary/semi-structured_interview/)).
...
A research method where one moderator conducts a roundtable-style interview with a group of approximately 4-8 people ([reference](https://surveroid.jp/mr-journal/interview/kNQI6)).
...
|-------|-----------------|----------|
| [**AttrakDiff**](https://www.attrakdiff.de/index-en.html) | Pragmatic and hedonic quality of products | A classic UX scale evaluating both usability and attractiveness |
| [**UEQ / UEQ-S**](https://www.ueq-online.org/) ([survey sample](https://forms.gle/4FhLjZGfVuAUm4u56)) | Overall UX | The 8-item short version (UEQ-S) is quick and easy to administer |
| **SAM** ([survey sample](https://docs.google.com/forms/d/e/1FAIpQLScWdaTtI_owkrPHgYtuEQ3K04oPTCGoOkwQx-ISzsYszVpsHg/viewform)) | Emotion (valence, arousal) | Responses are given using illustrations (manikins) rather than words, making it language-independent |
...
| [**PRS**](https://www.researchgate.net/profile/Seiji-Shibata-2/publication/235659586_Perceived_restorativeness_in_everyday_environments/links/0fcfd5125b523bcbb7000000/Perceived-restorativeness-in-everyday-environments.pdf) | Perceived restorativeness of places | Evaluates how much psychological rest a space provides across 4 factors |
| [**PANAS**](https://www.jstage.jst.go.jp/article/jjpjspp/9/2/9_KJ00001287160/_pdf) | Positive and negative affect | A scale that evaluates positive and negative affect as two independent axes |
...
- **[Reflexive Thematic Analysis (RTA)](/en/evaluate/rta)** --- A method for identifying meaningful **themes** in qualitative data such as open-ended survey responses or interviews. Its key feature is that it actively treats the researcher's subjectivity not as a bias to be eliminated, but as a **resource for analysis**. The process involves assigning codes, grouping them into provisional themes, and iteratively refining them. A [seminar exercise plan and worksheet](/en/evaluate/rta) is also provided
